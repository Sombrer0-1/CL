...
本机磁盘占用（已解压，2026-09-16）：CIFAR-10 约 341 MiB，CIFAR-100 约 339 MiB，CORe50 mini 32×32 约 3.4 GiB，Endless 分类约 14 GiB。第三阶段正式比较只需 **CIFAR-100 + CORe50 mini**（约 3.7 GiB）；Endless 不是 effectiveness_v3 必下集合。
